...
namespace BlazorAppWeb.Server.Migrations
{
    ...
    [Migration("20221126210252_Orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorAppWeb.Shared.Models.CartItem", b =>
                {
            ...
            modelBuilder.Entity("BlazorAppWeb.Shared.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BlazorAppWeb.Shared.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BlazorAppWeb.Shared.Models.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("BlazorAppWeb.Shared.Models.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BlazorAppWeb.Shared.Models.ProductVariant", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BlazorAppWeb.Shared.Models.OrderItem", b =>
                {
                    b.HasOne("BlazorAppWeb.Shared.Models.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorAppWeb.Shared.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorAppWeb.Shared.Models.ProductType", "ProductType")
                        .WithMany()
            ...
            modelBuilder.Entity("BlazorAppWeb.Shared.Models.Product", b =>
                {
                    b.HasOne("BlazorAppWeb.Shared.Models.Category", "Category")
                        .WithMany()
